...
import { ArrowRight, Star, Shield, Clock, MapPin, Bike, ChevronRight, CheckCircle2, Play } from 'lucide-react';
      ...
      <section className="relative h-[90vh] flex items-center overflow-hidden bg-on-surface">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 w-full">
          <div className="max-w-3xl">
            ...
            >
              Curated fleet of premium motorbikes for the discerning traveler. Explore Vietnam's hidden gems with style and reliability.
            </motion.p>
            ...
            >
              ...
              >
                Explore Fleet <ArrowRight size={22} className="group-hover:translate-x-1 transition-transform" />
              </Link>
        ...
        <div className="absolute bottom-12 right-12 hidden lg:flex gap-12 text-white">
          <div>
            ...
            <p className="text-xs font-bold text-white/50 uppercase tracking-widest">Happy Riders</p>
          </div>
          <div className="w-px h-12 bg-white/20"></div>
          <div>
            <p className="text-4xl font-bold mb-1">12</p>
            <p className="text-xs font-bold text-white/50 uppercase tracking-widest">Cities Covered</p>
          </div>
          <div className="w-px h-12 bg-white/20"></div>
          <div>
            <p className="text-4xl font-bold mb-1">4.9</p>
            <p className="text-xs font-bold text-white/50 uppercase tracking-widest">Average Rating</p>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 -mt-12 relative z-20">
        <div className="bg-white rounded-[2.5rem] p-8 shadow-2xl border border-outline-variant/10 flex flex-wrap items-center gap-8">
          <div className="flex-1 min-w-[200px] space-y-2">
            <label className="text-[10px] uppercase font-bold text-secondary tracking-wider">Location</label>
          ...
          <div className="flex-1 min-w-[200px] space-y-2">
            <label className="text-[10px] uppercase font-bold text-secondary tracking-wider">Pickup Date</label>
            <div className="flex items-center gap-3">
              <Clock size={20} className="text-primary" />
              <input type="date" className="bg-transparent font-bold text-on-surface focus:outline-none w-full cursor-pointer" />
            </div>
          </div>
          <div className="w-px h-12 bg-outline-variant/20 hidden md:block"></div>
          <div className="flex-1 min-w-[200px] space-y-2">
            <label className="text-[10px] uppercase font-bold text-secondary tracking-wider">Bike Type</label>
            <div className="flex items-center gap-3">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-32">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-xl">
            <h2 className="text-4xl md:text-5xl font-bold text-on-surface mb-6 tracking-tight">Our Featured Fleet</h2>
            <p className="text-secondary text-lg">Hand-picked premium motorbikes maintained to the highest standards for your safety and comfort.</p>
          </div>
          <Link to="/bikes" className="group flex items-center gap-2 text-primary font-bold text-lg hover:underline">
            View All Fleet <ChevronRight size={20} className="group-hover:translate-x-1 transition-transform" />
          </Link>
        </div>
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-lg font-bold text-on-surface group-hover:text-primary transition-colors">{bike.name}</h3>
                  ...
                  <div className="mt-auto pt-6 border-t border-outline-variant/10 flex justify-between items-center">
                    <div className="flex items-baseline gap-1">
                      <span className="text-xl font-bold text-on-surface">{formatPrice(bike.pricePerDay)}</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-white/60 text-lg mb-12 max-w-lg">
                We're not just a rental service. We're your partners in adventure, providing the best gear and support for your journey.
              </p>
              
              <div className="space-y-6">
                {[
                  { title: "Premium Fleet", desc: "Only latest models from top brands, meticulously maintained." },
                  { title: "Full Insurance", desc: "Comprehensive coverage included with every rental." },
                  { title: "24/7 Roadside Assistance", desc: "We're always just a call away, anywhere in Vietnam." },
                  { title: "Flexible Pickup", desc: "Pickup and drop-off at airports, hotels, or our city hubs." }
                ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="bg-primary rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-primary/30">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl md:text-7xl font-bold text-white mb-8 tracking-tighter">Ready to start your <br /> Vietnamese journey?</h2>
              <p className="text-white/80 text-xl mb-12 max-w-2xl mx-auto">
                Join thousands of happy riders who explored Vietnam with VeloRent. Book your bike today and get 10% off your first rental.
              </p>
              <Link 
                to="/bikes" 
              ...
              >
                Book Your Ride <ArrowRight size={24} className="group-hover:translate-x-1 transition-transform" />
              </Link>
            </div>
          </div>
        </div>
