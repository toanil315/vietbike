    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-on-surface">Tạo đơn đặt xe thủ công</h1>
            <p className="text-sm text-secondary">Thêm yêu cầu thuê xe của khách vào hệ thống một cách thủ công</p>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-3xl border border-outline-variant/10 shadow-sm space-y-4">
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-on-surface ml-1">Tên khách hàng *</label>
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-on-surface ml-1">Số điện thoại</label>
                <div className="relative">
          ...
          <div className="bg-white p-6 rounded-3xl border border-outline-variant/10 shadow-sm space-y-4">
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-on-surface ml-1">Ứng dụng nguồn</label>
                <select 
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-on-surface ml-1">Biển số xe *</label>
                <div className="relative">
        ...
        <div className="bg-white p-6 rounded-3xl border border-outline-variant/10 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-on-surface ml-1">Ngày bắt đầu *</label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-on-surface ml-1">Số ngày thuê</label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-on-surface ml-1">Ngày trả xe</label>
              <div className="relative">
                <Calendar size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-secondary" />
                <input 
                  type="datetime-local" 
        ...
        <div className="bg-white p-6 rounded-3xl border border-outline-variant/10 shadow-sm space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-on-surface ml-1">Tổng số tiền (VNĐ)</label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-on-surface ml-1">Số tiền đặt cọc (VNĐ)</label>
              <div className="relative">
                <DollarSign size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-secondary" />
                <input 
                  type="number" 
        ...
        <div className="bg-white p-6 rounded-3xl border border-outline-variant/10 shadow-sm space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-on-surface ml-1">Thông tin gia hạn</label>
              <input 
                type="text" 
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-on-surface ml-1">Ghi chú</label>
              <textarea 
                rows={4}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-on-surface ml-1">Giấy tờ (CCCD, Bằng lái, v.v.)</label>
              <div className="border-2 border-dashed border-outline-variant/20 rounded-3xl p-8 flex flex-col items-center justify-center gap-3 bg-surface-container/10 hover:bg-surface-container/20 transition-default cursor-pointer group">
                ...
                <div className="text-center">
                  <p className="text-sm font-bold text-on-surface">Nhấp để tải lên hoặc kéo thả vào đây</p>
                  <p className="text-xs text-secondary">PNG, JPG hoặc PDF (tối đa 10MB)</p>
                </div>
